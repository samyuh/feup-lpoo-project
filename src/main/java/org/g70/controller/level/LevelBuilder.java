    ...
    private void loadElements() {
        ...
        for(int yi = 0; yi < this.mapElements.size(); yi++) {
            for(int xi = 0; xi < this.mapElements.get(yi).length() ; xi++) {
                ...
                if(c == 'W')
                    walls.add(new Wall( new Position(xi + 2,yi+2)));
                if(c == '.')
                ...
                if(c == 'T')
                    teleports.add(new Teleport( new Position(xi + 2,yi+2)));
                if(c == 'K')
                    levelModel.setKey(new Key(new Position(xi + 2,yi+2)));
                if(c == 'L')
                    levelModel.setLock(new Lock(new Position(xi + 2,yi+2)));
                if(c == 'S')
